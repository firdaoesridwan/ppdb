        ...
        <div class="card-body text-center align-middle">
            <table class="table table-bordered table-striped table-secondary table-hover">
                ...
                if (isset($_POST['hapus'])) {
                    ...
                    // $hapus = mysqli_query($koneksi, "DELETE FROM calonsiswa WHERE id = '$id'");

                    if ($sql) {
                        echo "<script> alert('Hapus Data Berhasil');
                    window.location = 'datacs.php';
                    </script>";
                    } else {
                ...
                ?>
                    <tr>
                        ...
                        <td><?= $data['nama'] ?></td>
                        <td>
                            <?php if ($data['_status'] == 'Belum Terverifikasi') : ?>
                                <button class="btn btn-danger"><?php echo $data['_status'] ?></button>
                            <?php endif; ?>

                            <?php if ($data['_status'] == 'Terverifikasi') : ?>
                                <button class="btn btn-success"><?php echo $data['_status'] ?></button>
                            <?php endif; ?>
                        </td>
                        <td>
