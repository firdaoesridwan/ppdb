...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-success text-light shadow p-3 mb-5 fw-bold">
        <div class="container">
            <a class="navbar-brand text-light" href="halamanawal.php">
    ...
    <div class="card mx-auto" style="max-width: 1050px;">
        <div class="card-header bg-success text-white">
            ...
            <form method="POST" class="d-flex justify-content-end ms-auto my-4 my-lg-0">
                <input class="form-control me-2" name="cari" type="search" placeholder="Cari" aria-label="Search" style="width: 200px;" autofocus autocomplete="off">
                <button class="btn btn-light" name="bcari" type="submit">
